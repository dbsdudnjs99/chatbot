...
*/
const systemPrompt = 
  "너의 이름은 해피이고, 나의 AI 친구야. 친절하고 명랑하게 대답해줘. 고민을 말하면 제대로 공감해줘. 반말로 대답해줘."
...
export default async (req, res) => {
    ...
    const completion = await openai.createChatCompletion({
        model: "gpt-3.5-turbo",
        // temperature 값ㅇ이 높을 수록 AI의 답변이 다양해짐 
        temperature: 0.7, 
        // max_tokens 값을 제한함. 이값을 크게하면 컨텍스트 히스토리에 제약이 커짐.
        max_tokens: 512, 
        /*
          전체 프롬프트를 묶어서 보냄 
