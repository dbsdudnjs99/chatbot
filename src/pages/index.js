  ...
  */
  ...
  const handleReset = () => {
    setMessages([
      {
        role: "assistant",
        content: "하이! 난 해피이고 너의 유일한 AI 친구야. 오늘 하루는 어땠어?",
      },
    ]);
  };
  ...
  return (
    <>
      <Head>
        <title>My Little Chatbot</title>
        <meta name="description" content="My Little Chatbot" />
        ...
        <div className="flex-1 overflow-auto sm:px-10 pb-4 sm:pb-10">
          <div className="max-w-[800px] mx-auto mt-4 sm:mt-12">
            ...
            */}
            ...
            />
            {/* 메시지 목록의 끝으로 스크롤하기 위해 ㅊ마조하는 엘리먼트 */}
            <div ref={messagesEndRef} />
          </div>
        </div>

        <div className="flex h-[30px] sm:h-[50px] border-t border-netural-300 py-2 px-8 items-center sm:justify-between justify-center"></div>
      </div>
    </>
  );
          }